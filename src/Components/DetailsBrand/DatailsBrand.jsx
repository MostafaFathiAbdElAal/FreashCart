...
export default function DatailsBrand({ dataSpecificBrand, setDataSpecificBrand }) {
    ...
    return <>
        ...
        <section className={`w-3/4 sm:max-md:w-[60%] md:w-1/2 mt-32 bg-white rounded-md p-4 space-y-5 ${isShow ? "" : "-translate-y-full opacity-0"} ${isClose ? "-translate-y-full opacity-0" : ""} transition-[transform,opacity,left] duration-[700ms,500ms]`}>
