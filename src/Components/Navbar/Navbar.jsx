...
export default function Navbar() {
    ...
    return <>
        <nav className="bg-light-white py-4 lg:py-2 lg:flex lg:flex-wrap fixed top-0 lg:h-20 left-0 right-0 z-[9999]">
            <div className={`lg:container relative flex ${!token ? "justify-between pe-2" : null}  items-center gap-6`}>
                ...
                {token ? <ul id="Basenav" className="flex flex-1 gap-4 bg-white lg:bg-transparent lg:gap-6 items-center justify-center h-0 overflow-hidden w-full absolute top-11 lg:top-0 flex-col lg:flex-row lg:static lg:h-full">
                    <li>
